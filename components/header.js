        ...
        <div className="container flex flex-wrap md:justify-between items-center mx-auto justify-end ">
          ...
          <div className={`${show ? "" : "hidden"} w-full md:block md:w-auto`} id="navbar-default">
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
              <li>
                <a onClick={() => router.push("/")} href="#" className="block py-2 pr-4 pl-3  rounded md:bg-transparent md:text-blue-700 md:p-0 " aria-current="page">Home</a>
              </li>
              <li>
                <a onClick={() => router.push("/about")} href="#" className="block py-2 pr-4 pl-3   rounded md:bg-transparent md:text-blue-700 md:p-0 " aria-current="page">About</a>
              </li>
              <li>
