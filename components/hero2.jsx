    ...
    return (
        <div className="hero2 w-screen h-screen flex flex-wrap flex-col items-center md:justify-evenly md:flex-row ">
            ...
            <div className="content md:w-1/2 md:p-12 p-5">
                ...
                <button style={{minWidth:"125px"}} className="bg-black w-1/2 h-10 rounded font-semibold min-w-min flex justify-center items-center text-white mt-2 pr-3 pl-3 box-border ">
